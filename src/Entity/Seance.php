...
class Seance
{
    ...
    public function validateNomSeance(ExecutionContextInterface $context): void
    {
        if (strlen($this->nom) < 3) {
            $context->buildViolation('Le nom de la séance doit comporter au moins 3 caractères.')
                ->atPath('nom')  // Indiquez le chemin vers le champ concerné
                ->addViolation();
        }
    } 
    #[ORM\Column]
    ...
    {
        // Initialisation à 'programmée' par défaut
    ...
    // Getter et setter pour l'attribut
    ...
    {
        // Vérifier que le nombre de participants inscrits n'excède pas la capacité maximale
